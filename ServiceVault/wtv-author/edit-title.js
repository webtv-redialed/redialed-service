...
<input type=text name="docTitle" bgcolor=192133 text=CACA4A font=proportional value="${
        page.title
    }" SIZE=28 MAXLENGTH=64 COLS=45 autoactivate selected>
<tr><td height=0>
<tr>
<td valign=top align=left colspan=2>
<font color=AEBFD1>Type your page's description:</font><spacer type=vertical size=3><br></spacer>
<TEXTAREA name="docDesc" bgcolor=192133 cursor=#cc9933 text=CACA4A font=proportional value="${
        page.description
    }"
...
<input type=checkbox value=${!page.showtitle} `;
    if (page.showtitle == true) data += "checked";
    data += `
