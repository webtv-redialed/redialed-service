...
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start]}">
<img src="clipart/icons/Sports/Baseball/${files[start]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 1]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 1]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 1]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 2]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 2]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 2]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 3]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 3]}">
...
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 4]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 4]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 4]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 5]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 5]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 5]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 6]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 6]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 6]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 7]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 7]}">
...
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 8]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 8]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 8]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 9]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 9]}">
<img src="clipart/icons/Sports/Baseball/${files[start + 9]}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 10]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 10]}">
<img src="clipart/icons/Sports/Baseball/${
    files[start + 10]
}" width=64 height=64>
</td>
<td border=1 width=64 align=center valign=middle
href="wtv-author:/add-media-to-block?docName=WebDD9&blockNum=13&blockClass=23&mediaPath=clipart%2FSports%2FBaseball%2F${
    files[start + 11]
}&thumbnailPath=clipart%2Ficons%2FSports%2FBaseball%2F${files[start + 11]}">
<img src="clipart/icons/Sports/Baseball/${
    files[start + 11]
}" width=64 height=64>
</td>
