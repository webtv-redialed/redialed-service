...
Location: wtv-author:/documents`;
    ...
    var discardAlert = function (docName) {
        return new clientShowAlert({
            message:
                "Would you like to permanently discard this document and all of its contents?",
    ...
    var unpublishAlert = function (docName) {
        return new clientShowAlert({
            message:
                "Would you like to unpublish this document? You can republish it later.",
...
<font size=2 color=AEBFD1>`;
    if (page.published == true) data += `published ${page.publishdate}`;
...
<a href="${discardAlert(
        docName
    )}"><font effect=shadow><B>Discard page</B></font></a>
<BR><spacer type=block width=18 height=30 align=top>
<font color=AEBFD1>
