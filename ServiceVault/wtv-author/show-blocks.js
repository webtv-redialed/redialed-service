...
var style = page.style.replace(/_/gi, " ").replace(/'/gi, "%27");
...
for (let i = 0; i < page.pagebreaks.length; i++) {
    data += `<CENTER>
<A href="wtv-author:/edit-block?docName=${docName}&blockNum=${
        page.pagebreaks[i]
    }" ID="B2">
...
<IMG src=wtv-author:/ROMCache/up_arrow.gif> </TD>
<TD colspan=3 rowspan=3 align=center>
<EMBED src="wtv-author:/block-preview?docName=${docName}&pageNum=${
        i + 2
    }" vspace=1 hspace=1 width=394>
</TD>
</TR>
<TR>
<TD align=center width=10 background=wtv-author:/ROMCache/vert_line.gif></TD>
