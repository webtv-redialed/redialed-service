...
<tr>
<td>
<font size="-1"><a href=http://${site}/${session_data.getSessionData(
    "subscriber_username"
)}/${page.publishname}/>http://${site}/${session_data.getSessionData(
    "subscriber_username"
)}/${page.publishname}/</a></font>
<tr>
<td absheight=15>
<tr>
<td>
...
<input type=hidden name=message_url value="http://${site}/${session_data.getSessionData(
    "subscriber_username"
)}/${page.publishname}/">
...
<td>
<img src=wtv-author:/ROMCache/pointer.gif align=absmiddle width=13 height=22 hspace=0>
<a href=wtv-setup:/appendto-mail-signature?appendstringURL=http%3A%2F%2F${encodeURIComponent(
    site
)}%3A1640%2F${session_data.getSessionData("subscriber_username")}%2F${
    page.publishname
}%2F&appendstring=${
    page.title
}&alert=The%20address%20has%20been%20added%20to%20your%20mail%20signature.
