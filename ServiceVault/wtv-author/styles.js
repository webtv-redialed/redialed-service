...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=0#minus" id=minus><tr><td><img src="wtv-author:/ROMCache/minus_button.gif">
</table>
</td>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=2#plus" id=plus><tr><td><img src="wtv-author:/ROMCache/plus_button.gif">
</table>
</td>
</tr>
</table>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=1#minus" id=minus><tr><td><img src="wtv-author:/ROMCache/minus_button.gif">
</table>
</td>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=3#plus" id=plus><tr><td><img src="wtv-author:/ROMCache/plus_button.gif">
</table>
</td>
</tr>
</table>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=2#minus" id=minus><tr><td><img src="wtv-author:/ROMCache/minus_button.gif">
</table>
</td>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=4#plus" id=plus><tr><td><img src="wtv-author:/ROMCache/plus_button.gif">
</table>
</td>
</tr>
</table>
...
<TD width=128 height=120 bgcolor=#8A99B0
href="save-style?docName=${docName}
&layoutTMPL=Itsagirl.tmpl&contentTMPL=&styleName=It%27s a Girl
&blocksPerPage=0"
name="It%27s a Girl
"
>
...
<TD width=128 height=120 bgcolor=#8A99B0
href="save-style?docName=${docName}
&layoutTMPL=Itsaboy.tmpl&contentTMPL=&styleName=It%27s a Boy
&blocksPerPage=0"
name="It's a Boy
"
>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=3#minus" id=minus><tr><td><img src="wtv-author:/ROMCache/minus_button.gif">
</table>
</td>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=5#plus" id=plus><tr><td><img src="wtv-author:/ROMCache/plus_button.gif">
</table>
</td>
</tr>
</table>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=4#minus" id=minus><tr><td><img src="wtv-author:/ROMCache/minus_button.gif">
</table>
</td>
...
href="wtv-author:/styles?tmplClass=11&docName=${docName}&styleName=${styleName.replace(
                /'/gi,
                "%27"
            )}&pageNum=1#plus" id=plus><tr><td><img src="wtv-author:/ROMCache/plus_button.gif">
</table>
</td>
</tr>
</table>
