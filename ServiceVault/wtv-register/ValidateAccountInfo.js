...
if (!request_headers.query.registering) {
    ...
    if (!request_headers.query.registering) errpage = wtvshared.doErrorPage(400);
        ...
        errpage = wtvshared.doErrorPage(
            400,
            "Please enter your name. This can be your real name, or your well-known online alias."
        );
        ...
        errpage = wtvshared.doErrorPage(
            400,
            "The username you have chosen contains invalid characters. Please choose a username with only <b>letters</b>, <b>numbers</b>, <b>_</b> or <b>-</b>. Also, please be sure your username begins with a letter."
        );
    else if (
    ...
    else if (!request_headers.query.subscriber_contact)
        errpage = wtvshared.doErrorPage(
            400,
            "Please enter your contact information."
        );
    else if (request_headers.query.subscriber_contact_method == "")
        errpage = wtvshared.doErrorPage(
            400,
            "Please select the type of contact information you provided."
        );
...
Content-Type: text/html`;
        ...
        var main_data = "";
        if (!isOldBuild)
            main_data += `<table cellspacing=0 cellpadding=0 border=0 width=560 bgcolor=#171726>
<tr><td>`;
