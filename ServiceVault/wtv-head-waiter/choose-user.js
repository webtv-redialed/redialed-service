...
<tr>
<td align=right>
<img src="ROMCache/NameBanner.gif" width=50 height=125>
<tr>
<td absheight=8>
</table>
</sidebar>
...
for (const [key, value] of Object.entries(accounts)) {
    ...
    data += `<a href=/ValidateLogin?user_id=${user_id}&user_login=true&noupdate=true nocancel>`;
    if (key == "subscriber")
...
// only show this button on plus because classic users don't deserve the right to hang up
if (session_data.hasCap("client-has-tv-experience")) {
    data += `<input type=submit name=hangup value="Hang Up" borderimage="file://ROM/Borders/ButtonBorder2.bif" useStyle width=110><spacer width=20 type=horizontal>`;
}
data += `
</table>
</form>
