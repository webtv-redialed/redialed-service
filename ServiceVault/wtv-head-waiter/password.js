...
<tr>
<td align=right> 
<img src="ROMCache/PasswordBanner.gif" width=50 height=191> <tr> <td absheight=8> 
</table>
</sidebar>
...
nohtilebg
bgcolor=191919 
text="AA9B4A" link=189cd6 vlink=189cd6 hspace=0 fontsize="${session_data.isJapaneseClient() ? `medium` : `large`}"> <form action=/ValidateLogin enctype="x-www-form-encoded" method=post> <input type="hidden" NAME="target-url" VALUE=""> <table cellspacing=0 cellpadding=0> 
<tr>
<td width=20>
