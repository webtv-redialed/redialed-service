...
async function throwError(e) {
    ...
    wtvnewsserver.refartServer()
    sendToClient(socket, errpage[0], errpage[1]);
}

async function throwSelError(e) {
    console.log(e);
    console.log("HEY LOOK AT MY SELECT ERROR BTICH");
    var errpage = wtvshared.doErrorPage(400, e.toString());
    sendToClient(socket, errpage[0], errpage[1]);
}
        ...
        .then(() => {
            wtvnews
                ...
                .then((response) => {
                    ...
                    var page = request_headers.query.chunk
                        ? parseInt(request_headers.query.chunk)
                        : 0;
                    ...
                    if (page_end > response.group.high) {
                        ...
                        limit_per_page =
                            page_end - limit_per_page / (page + 1) + limit_per_page;
                    }
					limit_per_page = 100;
                    wtvnews
                        .listGroup(group, page, limit_per_page)
                        .then((response) => {
                            if (response.code == 211) {
                                NGCount = response.group.number;
                                NGArticles = response.group.articleNumbers;
                                page_start = limit_per_page * page;
...
<tr>
<td maxlines=1>
<shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="E7CE4A">Lobby</font></shadow></table>
</table>
<td abswidth=5>
<tr>
<td colspan=3 absheight=2 valign=middle align=center bgcolor=231d22>
...
<tr>
<td maxlines=1>
<shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="E7CE4A">Post</font></shadow></table>
</table>
<td abswidth=5>
<tr>
<td colspan=3 absheight=2 valign=middle align=center bgcolor=231d22>
...
<tr>
<td maxlines=1>
<shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="E7CE4A">Help</font></shadow></table>
</table>
<td abswidth=5>
<tr>
<td colspan=3 absheight=2 valign=middle align=center bgcolor=231d22>
...
${
                                                page > 0
                                                    ? `<a href="wtv-news:/news?group=${group}&chunk=${page - 1}${
                                                        limit_per_page != page_limit_default ? `&limit=${limit_per_page}` : ""
                                                    }"><img src="wtv-news:/images/ListPrevious.gif"></a>`
                                                    : `<img src="wtv-news:/images/ListPrevious_D.gif">`
                                            }
...
${
                                                page_end < NGCount
                                                    ? `<a href="wtv-news:/news?group=${group}&chunk=${page + 1}${
                                                        limit_per_page != page_limit_default ? `&limit=${limit_per_page}` : ""
                                                    }"><img src="wtv-news:/images/ListNext.gif"></a>`
                                                    : `<img src="wtv-news:/images/ListNext_D.gif">`
                                            }
...
<td height=6>
                                        ...
                                        if (NGCount > 0) {
                                            Object.keys(messages).forEach(function (k) {
                                                ...
                                                var has_relation =
                                                    messages[k].relation !== null ? true : false;
                                                var date_obj = new Date(
                                                    Date.parse(message.headers.DATE)
                                                );
                                                var date = isToday(date_obj)
                                                    ? strftime("%I:%M %p", date_obj)
                                                    : strftime("%b %d", date_obj);
                                                data += `
<table cellspacing=0 cellpadding=0>
<tr>
<td abswidth=10>
<td abswidth=426 height=42 valign=bottom>
<table cellspacing=0 cellpadding=0 href="wtv-news:/news?group=${
                                                    request_headers.query.group
                                                }&article=${message.articleNumber}" id="${
                                                    message.messageId
                                                }" nocolor selected>
<tr>
${
                                                    has_relation
                                                        ? `<td abswidth=20 rowspan=2 valign=top><font size="+2">&#149;`
                                                        : ""
                                                }
<td abswidth=426 maxlines=1>
<font color=1bb0f1>${
                                                    wtvshared.stripHTML(message.headers.SUBJECT)
                                                        ? wtvshared.stripHTML(
                            ...
                            if (attachments) {
                                if (Object.keys(attachments).length > 0) {
                                    Object.keys(attachments).forEach((k) => {
                                        if (
                                            attachments[k].filename == "wtv_signature.html" &&
                                            attachments[k].content_type.match(/text\/html/)
                                        ) {
...
<title>
${
                                wtvshared.stripHTML(response.article.headers.SUBJECT)
                                    ? wtvshared.stripHTML(response.article.headers.SUBJECT)
                                    : "(No subject)"
                            }
</title>
...
<td absheight=1>
<tr>
<td maxlines=1><shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="E7CE4A">Group</font></shadow>
</table>
</table>
<td abswidth=5>
<tr>
...
<td abswidth=93 absheight=26 >
<table bgcolor=3d2f3a cellspacing=0 cellpadding=0${
                                response.next_article
                                    ? ` href="wtv-news:/news?group=${request_headers.query.group}&article=${response.next_article}"`
                                    : ""
                            }>
<tr>
<td abswidth=5>
<td abswidth=88 valign=middle align=left >
<table cellspacing=0 cellpadding=0><tr><td><shadow><font color="${
                                response.next_article ? "#E7CE4A" : "#5b4b58"
                            }" sizerange=${session_data.isJapaneseClient() ? `small` : `medium`}>Previous</font></shadow></table>
</table>
<td abswidth=5>
<tr>
<td colspan=3 absheight=2 valign=middle align=center bgcolor=202434>
...
<td abswidth=93 absheight=26 >
<table bgcolor=3d2f3a cellspacing=0 cellpadding=0${
                                response.prev_article
                                    ? ` href="wtv-news:/news?group=${request_headers.query.group}&article=${response.prev_article}"`
                                    : ""
                            }>
<tr>
<td abswidth=5>
<td abswidth=88 valign=middle align=left >
<table cellspacing=0 cellpadding=0><tr><td><shadow><font color="${
                                response.prev_article ? "#E7CE4A" : "#5b4b58"
                            }" sizerange=${session_data.isJapaneseClient() ? `small` : `medium`}>Next</font></shadow></table>
</table>
<td abswidth=5>
<tr>
<td colspan=3 absheight=2 valign=middle align=center bgcolor=202434>
...
<td absheight=1>
<tr>
<td maxlines=1><shadow><font color=5b4b58 sizerange=${session_data.isJapaneseClient() ? `small` : `medium`}>Next New</font></shadow>
</table>
</table>
<td abswidth=5>
<tr>
...
<td absheight=1>
<tr>
<td maxlines=1><shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="5b4b58">Mail to</font></shadow>
</table>
</table>
<td abswidth=5>
<tr>
...
<td absheight=1>
<tr>
<td maxlines=1><shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="E7CE4A">Respond</font></shadow>
</table>
</table>
<td abswidth=5>
<tr>
...
${strftime(
                                "%a, %b %e, %Y, %I:%M%P",
                                new Date(Date.parse(response.article.headers.DATE))
                            )}
<font size=-1> </font>
<tr>
<td valign=top>
...
<td>`;
                            ...
                            data += `${wtvshared.sanitizeSignature(
                                wtvshared.htmlEntitize(response.article.headers.FROM)
                            )}`;
                            //                }
...
`;
                            data += `
${linkify(wtvshared.sanitizeSignature(wtvshared.htmlEntitize(message_body, true)))}
<br>
<br>`;
                            ...
                            if (attachments) {
                                ...
                                var supported_audio =
                                    /audio\/(mp[eg|2|3]|midi?|wav|x-wav|mod|x-mod)/;
                                attachments.forEach((v, k) => {
                                    if (v.content_type) {
                                        if (v.content_type.match(supported_images))
                                            ...
                                            data += `<table href="wtv-news:/get-attachment?group=${group}&article=${article}&attachment_id=${k}&wtv-title=${
                                                v.filename
                                                    ? encodeURIComponent(v.filename)
                                                    : "Audio%20file"
                                            }" width=386 cellspacing=0 cellpadding=0>
    <td align=left valign=middle><img src="wtv-news:/ROMCache/FileSound.gif" align=absmiddle><font color="#189CD6">&nbsp;&nbsp;${
                                                v.filename ? v.filename : "Audio file"
                                            } (${v.content_type.split("/")[1]} attachment)</font>
    <td align=right valign=middle>
    </table><br><br>`;
                                        else
                                            data += `<table width=386><td><td align=left valign=middle><font color="#565656"><i>A file ${
                                                v.filename ? `(${v.filename}) ` : ""
                                            }that WebTV cannot use, with type ${
                                                v.content_type
                                            } is attached to this message.</i></font>`;
                                    }
                                });
                            }
                            /*
                        ...
                        .catch((e) => {
                            ...
                            if (fs.existsSync(post_unavailable_file)) {
                                headers = "200 OK\nContent-type: text/html";
                                data = fs
                                    .readFileSync(post_unavailable_file)
                                    .toString("ascii")
                                    .replace("${group}", group)
                                    .replace(
                                    ...
                                    .replace(
                                        "${message_colors.bgcolor}",
                                        session_data.mailstore.defaultColors.bgcolor
                                    );
                                sendToClient(socket, headers, data);
                            } else {
                                throwError(e);
...
<tr>
<td maxlines=1>
<shadow><font sizerange=${session_data.isJapaneseClient() ? `small` : `medium`} color="E7CE4A">All groups</font></shadow></table>
</table>
<td abswidth=5>
<tr>
<td colspan=3 absheight=2 valign=middle align=center bgcolor=231d22>
