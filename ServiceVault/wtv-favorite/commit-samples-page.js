...
if (totalfavorites < 14) {
    if (createFun == "true") session_data.favstore.createTemplateFolder("Fun");
    ...
    if (createNews == "true") session_data.favstore.createTemplateFolder("News");

    if (createRecommended == "true")
        session_data.favstore.createTemplateFolder("Recommended");
    console.log(
        "FUGHFVJSGHJFDGIJUFDSHGFJDSKHJKLGFHJKHDJKHJKLGF " + createRecommended
    );
