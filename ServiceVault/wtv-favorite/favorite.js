...
<table href="wtv-guide:/help" width="100%" cellspacing="0" cellpadding="0">
<tbody><tr><td>
<table cellspacing="0" cellpadding="0">
<tbody><tr><td><shadow><font size="-1" color="E7CE4A">
 Help&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tbody><tr><td width="225" valign="middle" height="42" background="${imagesource}/LeftTop.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="40" height="20">
</td><td maxlines="1" width="140" height="20" align="center">
<a href="wtv-favorite:/serve-browser?favorite_folder_name=${
        folder_array[0]
    }" selected="">
<font size="-1">
<limittext value="${
        folder_array[0]
    }" width="140"></limittext></font></a><font size="-1">
</font>
</td><td width="20">
</td></tr></tbody></table>`;
    var kval = 0;
    ...
    Object.keys(folder_array).forEach(function (k) {
        ...
        if (parseInt(k) % 2 == 0) {
            // even
            // Left Middle
            data += `</td></tr><tr><td width="225" valign="middle" height="42" background="${imagesource}/LeftMiddle.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="40" height="20">
</td><td maxlines="1" width="140" height="20" align="center">
...
<limittext value="${folder_array[k]}" width="140"></limittext></font></a><font size="-1">
    ...
    if (folder_array.length > 1) {
        if (folder_array.length % 2 == 0) {
            data += `</td></tr><tr><td width="225" valign="middle" height="42" background="${imagesource}/LeftBottom.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="40" height="20">
</td><td maxlines="1" width="140" height="20" align="center">
</td><td width="20">
...
</td></tr><tr><td width="225" valign="middle" height="42" background="${imagesource}/RightTopEdgeOnly.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
...
</td></tr><tr><td width="225" valign="middle" height="42" background="${imagesource}/RightTop.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="5" height="20">
</td><td maxlines="1" width="140" height="20" align="center">
...
<limittext value="${folder_array[1]}" width="140"></limittext></font></a><font size="-1">
    ...
    Object.keys(folder_array).forEach(function (k) {
        ...
        if (parseInt(k) % 2 != 0) {
            // odd
            // Right Middle
            data += `</td></tr><tr><td width="225" valign="middle" height="42" background="${imagesource}/RightMiddle.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="5" height="20">
</td><td maxlines="1" width="140" height="20" align="center">
<a href="wtv-favorite:/serve-browser?favorite_folder_name=${folder_array[k]}">
...
<limittext value="${folder_array[k]}" width="140"></limittext></font></a><font size="-1">
    ...
    if (folder_array.length > 1) {
        if (folder_array.length % 2 != 0) {
            data += `</td></tr><tr><td width="225" valign="middle" height="42" background="${imagesource}/RightBottom.gif" align="center">
<table width="50%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="5" height="20">
</td><td maxlines="1" width="140" height="20" align="center">
</td><td width="20">
...
<table cellspacing="0" cellpadding="0">
<tbody><tr><td width="451" height="2" background="${imagesource}/FoldersCoverBorder.gif"><img src="wtv-home:/ROMCache/Spacer.gif" width="1" height="1">
</td></tr></tbody></table>
