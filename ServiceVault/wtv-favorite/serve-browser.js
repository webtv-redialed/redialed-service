...
// p.s. this doesn't work for downgraded LC2s, they will need our Cache partition. maybe add that with datadownload support?
...
data += engine.renderFileSync('wtv-favorite/partials/sidebar', { options: [{ url: 'wtv-favorite:/favorite', text: 'Folders' }, { url: `wtv-favorite:/serve-organize-favorites?favorite_folder_name=${foldername}`, text: 'Organize' }, {url: 'wtv-guide:/quickhelp?title=Favorites', text: 'Help'}] });
data += `
...
<tbody><tr>
<td align="left">
<shadow><blackface><font color="e7ce4a">Favorites for ${
    session_data.getSessionData("subscriber_username") || "You"
}
...
if (folderid !== 0) {
    data += `
<tbody><tr><td width="221" valign="middle" height="42" background="${imagesource}/LeftTopWithPreviousTab.gif" align="left">
<table width="100%" cellspacing="0" cellpadding="0">
<tbody><tr><td width="10"> </td><td width="20" valign="top" height="28" align="left">
<table cellspacing="0" cellpadding="0">
<tbody><tr><td height="1">
</td></tr><tr><td height="20">
<table href="wtv-favorite:/serve-browser?favorite_folder_name=${
        folder_array[folderid - 1]
    }&backward=selected" width="20" height="20" cellspacing="0" cellpadding="0">`;
} else {
    data += `
...
if (folderid !== numoffolders - 1) {
    data += `<table abswidth="52" cellspacing="0" cellpadding="0" background="${imagesource}/FarRightTopWithNextTab.gif">
...
<table href="wtv-favorite:/serve-browser?favorite_folder_name=${
        folder_array[folderid + 1]
    }&amp;forward=selected" selected="" width="20" height="20" cellspacing="0" cellpadding="0">
<tbody><tr><td>&nbsp;
</td></tr></tbody></table>
</td></tr></tbody></table>
...
<tbody><tr><td width="5" height="13"><img src="wtv-home:/ROMCache/Spacer.gif" width="1" height="1">
    ...
    data += `<tbody><tr></tr></tbody></table><table abswidth="52" cellspacing="0" cellpadding="0" background="${imagesource}/FarRightTop.gif">
<tbody><tr><td width="20" valign="middle" height="42" align="left">
