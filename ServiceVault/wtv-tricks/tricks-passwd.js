...
const theShit = [
    ...
    { name: "Visit Big Willie's!", url: `wtv-flashrom:/willie` },
    ...
    { name: "Rare Retro Gaming", url: `wtv-tricks:/gaming?password=${wtvt.getPasswordByType("low")}` }
];
...
<form action="wtv-tricks:/tricks-passwd">
...
} else if (request_headers.query.password == "fuck") {
    headers = `400 fuck`;
} else {
    headers = `200 OK
Content-Type: text/html`;
