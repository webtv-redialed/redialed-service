...
if (session_data.getSessionData("registered")) {
    ...
    var message =
        "Error: Your box is already registered. If you would like to re-register, you must first unregister.";
...
wtv-boot-url: wtv-1800:/preregister?relogin=true`;
    ...
    message = `Are you ready to register your box with ${minisrv_config.config.serviceName}?
<br><br>
