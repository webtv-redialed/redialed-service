...
<form action="wtv-setup:/validate-edit-restrictions">
...
<tr valign=top>
<td>
<input name=restricted_web_access type=radio bgcolor=#444444 value="unrestricted-access" ${userSession.getSessionData("subscriber_surfwatch_enabled") ? "" : "selected checked"}>
<td>
Unrestricted<br>access
<tr><td height=16>
<tr valign=top>
<td>
<input name=restricted_web_access type=radio bgcolor=#444444 value="surfwatch-screening" ${userSession.getSessionData("subscriber_surfwatch_enabled") ? "selected checked" : ""}>
<td>
