...
${userSession.getUserPasswordEnabled() ? "Password" : "No password"}
</a>`
        if (user_id != 0) {
            data += `
<tr>
...
<tr>
<td colspan=3 align=left>
<a href="wtv-setup:/edit-user-restrictions?user_id=${user_id}">
${userSession.getSessionData("subscriber_surfwatch_enabled") ? "SurfWatch&#153; Screening" : "No Web restrictions"}
</a>`
        }
        data += `
</table>
