...
data = `<html>
<head>
<title>Tip: Welcome to the Entertainment Center</title>
<script>
function otherTips() {
...
Tour the Entertainment Center</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
Get the latest scoop in "Top Stories."
<p>
Scroll down to see what's new in theaters.
<p>
Browse new movies on video and DVD.
</font>
</td>
<td>
...
<input action="wtv-center:/center?info=Entertainment" value="Entertainment" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=145>
<script>
otherTips()
</script>
