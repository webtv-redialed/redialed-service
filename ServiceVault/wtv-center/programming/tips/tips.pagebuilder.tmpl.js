...
<td>
<font size=5 color=273c33><blackface>Make your own Web page</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<font size=5>
<br>
Want a place of your own on the Web?<p>
With the handy <b>Page Builder</b> tool, you can build a Web page and publish
it for the <br> world to see.<p>
From <b>Web Home</b>, just choose the <b>More</b> <br>button and select <b>Page Builder</b>. Follow the easy instructions to get started.<p>
</font>
</td>
</tr>
</table>
...
<input action="wtv-guide:/help?topic=Publish&subtopic=Index" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
&nbsp;
<script>
otherTips()
</script>
&nbsp;&nbsp;<input action="javascript:location=history.go(-1);" value="Done" type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
</shadow></font>
&nbsp;&nbsp;
</form>
