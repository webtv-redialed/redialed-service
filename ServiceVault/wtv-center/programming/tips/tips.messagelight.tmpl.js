...
data = `<html>
<head>
<title>Tip: Check your mail automatically</title>
<script>
function otherTips() {
...
<td>
<font size=5 color=273c33><blackface>Automatically check for new mail</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
You know that thrill you get when the
light blinks on your answering machine?
<p>
You can have that same delight with your<br>
`;
if (romtype == "US-WEBSTAR-disk-0MB-16MB-softmodem-CPU5230" || romtype == "US-DTV-disk-0MB-32MB-softmodem-CPU5230")
    ...
    data += "WebTV Internet terminal"
data += `. With <b>Message light</b>, your box
automatically signs on to check for new
e-mail once a day, whenever you want.
<p>
Then, when the red light on your `;
if (romtype == "US-WEBSTAR-disk-0MB-16MB-softmodem-CPU5230" || romtype == "US-DTV-disk-0MB-32MB-softmodem-CPU5230")
    data += "satellite receiver"
else if (session_data.hasCap("client-has-tv-experience"))
    data += "WebTV Plus receiver"
...
<input action="http://help.webtv.net/mail/messages/auto.html" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>
&nbsp;
<script>
otherTips()
</script>
