...
data = `<html>
<head>
<title>Tip: Add photos on eBay</title>
<script>
function otherTips() {
...
<td>
<font size=5 color=273c33><blackface>Add photos on eBay</blackface></font>
</td>
</tr>
<tr>
<td><spacer type=vertical height=4></td>
</tr>
<tr>
<td>
<spacer type=horizontal width=105>
...
<td>
<font size=5>
Want to include a photo of the item you're selling on eBay?
<ol>
<li>Build a simple Web page in Page Builder and add the photo to the page.</li>
<li>Go to eBay and fill in the Sell form. </li>
<li>When you're entering the item description, include a link to
the page you built: <br>Type &lt;a href=&quot;url goes here&quot;&gt;text
goes here&lt;/a&gt;.</li>
</ol>
</font>
</td>
...
<input action="http://community-2.webtv.net/Rye_Whiskey/WebtvBay" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
&nbsp;
<script>
otherTips()
</script>
&nbsp;<input action="javascript:location=history.go(-1);" value="Done"
selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
</shadow></font>
</form>
