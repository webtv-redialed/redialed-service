...
data = `<html>
<head>
<title>Tip: Change your name</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Change your name</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=4>
To change your e-mail display name:<br>
1) Log on as the primary user. 2) Go to <b>Settings</b> from Web Home. 3) Choose <b>Mail</b>. 4) Select <b>Your name in e-mail</b>. 5) Type in the new name. <p>
To change an e-mail name for a secondary user, follow steps 1 and 2. Choose <b>Extra Users</b>, and then select the secondary user whose display name you want to change. Enter a new first and last name and choose <b>Done</b>.
</font>
</font>
</td>
<td>
