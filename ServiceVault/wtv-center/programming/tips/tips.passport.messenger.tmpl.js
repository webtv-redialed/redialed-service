...
data = `<html>
<head>
<title>Tip: Using Messenger</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Having trouble accessing Messenger?</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
In order to use Messenger, you must first:
<ul<li>Have taken the latest upgrade (If you haven't already, the next time you see an invitation to upgrade, accept it.)
<li>Have created a Windows Live ID(Choose <b>Messenger</b> from the WebTV home page, and follow the instructions to create a Live ID.)</ul>
</font>
</td>
<td>
...
<input action="wtv-guide:/help?topic=Passport&subtopic=Instructions" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>	&nbsp;
<script>
otherTips()
</script>
