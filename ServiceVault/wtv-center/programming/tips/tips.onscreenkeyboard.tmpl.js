...
data = `<html>
<head>
<title>Tip: Try the on-screen keyboard</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Try the on-screen keyboard </blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
Want to type with just your remote? Give the WebTV on-screen keyboard a try:
<ol><li>First , move the yellow selection box to where you want to begin typing (e-mail or Web address field for example).
<li>Press the center button on your remote control (the one inside the arrows) to bring up the on-screen keyboard.</ol>
</font>
</td>
<td>
...
<input action="wtv-guide:/help/Tips/OnScreenKeyboard/OnScreenKeyboard" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>
&nbsp;
<script>
otherTips()
</script>
