...
data = `<html>
<head>
<title>Tip: Check the Status Board</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Check the WebTV Status Board</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
Having trouble surfing the Web or checking e-mail? Check the Status Board to see what's happening with these and other WebTV features.
<p>
<ol><li>Go to <b>Web Home</b>. <li>Choose <b>Help</b>. <li>Under <b>Latest News</b>, choose <b>Status Board</b>.</ol> </font>
</td>
<td>
...
<input action="http://askwebtv.webtv.net/status/stat.html" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>
<script>
otherTips()
</script>
