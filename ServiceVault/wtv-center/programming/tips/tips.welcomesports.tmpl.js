...
data = `<html>
<head>
<title>Tip: Welcome to the Sports Center</title>
<script>
function otherTips() {
...
<td>
<font size=5 color=273c33><blackface>
To get the most from your Sports Center, try these things first:</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<b>Select "choose sports"</b> to get the scores you want. <spacer type=vertical height=22><br>
<b>Scroll down</b> the Sports Center page to "Sports Guides" for game listings. <spacer type=vertical height=22><br>
<b>Try "Sports Links"</b> to find the best sports sites on the Web.
</font>
</td>
<td>
...
<input action="wtv-center:/center?info=Sports" value="Sports" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=110>
<script>
otherTips()
</script>
