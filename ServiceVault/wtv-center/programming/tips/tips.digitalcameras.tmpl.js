...
data = `<html>
<head>
<title>Tip: Digital cameras</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Get digital camera info</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<font size=5>
<br>
Wondering if you can use a digital camera with your WebTV? <p>If you have a WebTV Plus or a DISHPlayer, you can! Just make sure the camera you buy has an audio/video output.
<p>
To learn more, choose the <b>More Info</b> link below. </font>
</td>
</tr>
</table>
</td>
...
<input action="wtv-guide:/help?topic=Mail&subtopic=Connections&page=AV" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
&nbsp;
<script>
otherTips()
</script>
