...
data = `<html>
<head>
<title>Tip: Surf to background Music</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>You can surf to music</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
Sometimes, surfing the Web can be pretty<br>
quiet. But it doesn't have to be. <p>
You can choose to play beckground music when you're online from a
variety of styles, including Bach, Funk and more.
<p>
Music to surf by. Cowabunga!
</font>
</td>
<td>
...
<input action="wtv-setup:/sound" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>
&nbsp;
<script>
otherTips()
</script>
