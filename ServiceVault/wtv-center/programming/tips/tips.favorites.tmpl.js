...
data = `<html>
<head>
<title>Tip: Save time with Favorites & shortcuts</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Save your favorite places</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
With <b>Favorites,</b> you can make a shortcut to anything you've found on the Web &#151; even discussion groups or chat rooms.
<p>
You can also program the "F-keys" on your keyboard to go to pages in your Favorites.
<p>
So, next time you find something you like, keep it just a keystroke away.
</font>
</td>
<td>
...
<input action="wtv-guide:/help?topic=Favorites&subtopic=Index" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=110>
&nbsp;
<script>
otherTips()
</script>
