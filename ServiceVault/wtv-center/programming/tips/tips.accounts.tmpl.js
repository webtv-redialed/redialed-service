...
data = `<html>
<head>
<title>Tip: Add an account</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>WebTV works for the family</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<td>
<font size=5>
You can create a separate account for everyone in the family. You can
have up to six user names, each with its own e-mail address, password
and Favorites.
<p>
And it won't cost anything extra.
<p>
Now your whole family can share the fun.
</font>
</td>
<td>
...
<input action="wtv-guide:/help?topic=Users&subtopic=AddUser" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>
&nbsp;
<script>
otherTips()
</script>
