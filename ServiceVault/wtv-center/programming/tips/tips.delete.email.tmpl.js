...
data = `<html>
<head>
<title>Tip: Delete e-mail addresses in a forward</title>
<script>
...
<td>
<font size=5 color=273c33><blackface>Delete e-mail addresses in a forward</blackface></font>
</td>
</tr>
<tr>
<td colspan=2>
...
<font size=5>
<br>
Wish you could forward an e-mail without all the extra stuff? Here's how:
<p>
1) Copy and paste the e-mail text into a new message. (To open up a new message, go back to your Mail list and choose <b>Write</b>.) <br>2) Move your cursor to the beginning of the line you wish to delete.<br> 3) Hold down the <b>Cmd</b> key and press <b>Delete</b>.
<p>
</font>
</td>
</tr>
...
<input action="wtv-center:/programming/tips/tips.cutcopypaste.tmpl" value="More Info" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=120>
<script>
otherTips()
</script>
