...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Settle it with Reversi</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<spacer type=vertical height=5><br>
			Can't decide where to eat? Whose turn it is for chores?

			<p>Why not let <b>Reversi</b> decide it! Strategically place stones to flip your opponent's, and claim the whole board!

			<p>Play your stones right, and you'll never do dishes again.
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://retrosite.org/WebTV/games/games4tv/reversi/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
