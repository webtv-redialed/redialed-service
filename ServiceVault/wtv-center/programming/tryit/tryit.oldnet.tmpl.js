...
<html>
<head>
	<title>Try It: The Old Net</title>
</head>
...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Rediscover old favorites</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<spacer type=vertical height=5><br>
			Have an old web site that you miss browsing?

			<p>Yearn no more! With <b>The Old Net</b>, you can browse just about any web site from any time period.

			<p>It's like nothing changed at all!
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://theoldnet.com/lite/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
