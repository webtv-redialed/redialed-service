...
<html>
<head>
	<title>Try It: MIDIs</title>
</head>

<body background="images/TryIt_bkg.swf" bgcolor=2e1722 fontsize=medium hspace=0 vspace=0 text=e5c0c0 link=e5c0c0 alink=e5c0c0 vlink=e5c0c0>
	<!-- INSTRUCTIONS:
...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Listen to music</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<A HREF="http://retrosite.org/MIDI/indexWTV.htm" selected>
			Find high quality MIDI files in JarHead's Music Warehouse</A>
			<spacer type=vertical height=36><br>
			<A HREF="news:alt.discuss.midi">
			Share MIDI files in Discuss</A>		
			<spacer type=vertical height=44><br>
			<A HREF="wtv-setup:/sound">
			Turn on background music in Settings</A>
			</font>
			</td>
