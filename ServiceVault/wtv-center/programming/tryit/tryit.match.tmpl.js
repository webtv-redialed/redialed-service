...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Test your brains with Match!</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<spacer type=vertical height=5><br>
			You think you're sharp? Why not put it to the test!

			<p><b>Match!</b> is a classic memory match game. Select a space to reveal its card, then find the matching card on the board.

			<p>Now, where did I put those keys...
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://retrosite.org/WebTV/games/games4tv/match/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
