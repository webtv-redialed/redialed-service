...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Go on a tour of the web</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<p>Even on the modern web, there are still new and old web sites in the classic style that we all adore. With <b>Wiby</b>, you can easily uncover them.

			<p>Now, I'm feeling lucky...
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://wiby.me/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
