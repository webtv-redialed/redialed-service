...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Have solo fun with Solitaire</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<spacer type=vertical height=5><br>
			There you are: a night to yourself, and nothing to do.

			<p>Fortunately, you'll never find yourself in a situation like this ever again. <b>Net4TV's Solitaire</b> is just that: a good old-fashioned game of Solitaire.

			<p>Now you won't have time for anything else!
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://retrosite.org/WebTV/games/games4tv/solitaire/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
