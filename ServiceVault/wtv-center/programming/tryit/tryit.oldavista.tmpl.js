...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Find classic web sites</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<spacer type=vertical height=5><br>
			Missing the simple times of Tripod and Geocities?

			<p>Great news! With <b>Old'aVista</b> as your guide, you can search through archives of old, personal web sites, and see how people used to express themselves.

			<p>Hey, look me up when you get there.
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://oldavista.com/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
