...
<table height=100% width=100% border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		...
		<tr>
			...
			<font size=5 color=b5b1e3><blackface>Visit the oldest online Webcam</blackface></font>
			</td>
		</tr>
		...
		<tr>
			...
			<spacer type=vertical height=5><br>
			Before livestreaming, we had a field.

			<p><b>FogCam</b> is the oldest operating live webcam, showing off continually-updating photos of the San Francisco State University campus.

			<p>It is a great field.
			</font>
			</td>
	...
	<tr align=right valign=bottom>
		...
		<input action="http://fogcam.org/" value="Try It" selected type=button borderimage="file://ROM/Borders/ButtonBorder2.bif" usestyle width=105>
		&nbsp;
