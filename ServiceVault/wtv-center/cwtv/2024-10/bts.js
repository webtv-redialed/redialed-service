...
<title>Behind The Scenes Updates & Future Goals</title>
</head>
...
<tr>
<td align=left> <spacer type=block width=1 height=5>
<table href=servermove width=140 cellspacing=0 cellpadding=0>
<tr><td align=left>
<font size=2 color=#7F86A5><blackface>New Server</blackface></font><br>
</table>
<spacer type=block width=1 height=5>
<tr>
<td align=left> <spacer type=block width=1 height=5>
...
<P>
<i>Organization? I'd NEVER!</i>
<p>
Some of you may already be aware, but there's been quite a few massive changes behind the scenes with how Redialed development is going to go from now on.
<p>
First of all, a massive expansion is being worked on and will be implemented throughout the next few years. Redialed is no longer just a "snapshot" of WebTV as it was in 1999, but now a total revival, continuing to be maintained with new features and quality of life improvements that even the original service never had, while still being accurate to how the original service looked and felt. This also means I'm working on replacements for any third party service WebTV once used//relied on, instead of having placeholder alert boxes for when you click on them.
<p>
On top of this, I founded an... organization, for lack of better words for not just Redialed, but CrossTalk (multi-protocol chat server, another project of mine) as well, called "the undergr0und". What this means is that, in essence, WebTV Redialed and CrossTalk are now sister projects.
<p>
Both services are planned to be architecturally redesigned, and will share development resources and, if I decided to take a microservices approach (which I'm still debating), those too.
<p>
I'll show off some new stuff created as a result of this in the future, but for now, these are my future goals.
<P>
