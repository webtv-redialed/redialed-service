  ...
  <tr>
    <td><table width="408" cellspacing="0" cellpadding="0" border="0">
      ...
      <tr>
        <td abswidth="40"></td>
        <td valign="top">
<b><font size="+5" color="#C0F9A3">I didn't update this for 9 months!</font><font size="5" color="#C0F9A3">
</font></b>
...
Most of you are probably aware of the changes in the past 9 months, but I need content sooo...
</p><p>
<blackface>Mail</blackface>
</p><p>
You can now send Mail to other users of the server. Not really much to say about this one, except that you'll hopefully be able to send and receive mail outside of the server soon as well.
</p><p>
<blackface>Discuss</blackface>
</p><p>
Discuss is now here as well. Now, normally these posts would remain until the server goes public, because we can't be carrying messages from beta over to production. However, they'll be even more temporary because we'll soon be switching over to real usenet, instead of the custom something we use right now.<br><br>
<strike>It's essentially 4chan WebTV edition</strike>
</p><p>
<blackface>Web Proxy</blackface>
</p><p>
We've switched over to a proxy that we run ourselves, meaning some pages or files that were previously having issues will probably work now. If you were having issues listening to your favorite midi, maybe give it another shot.
</p><p>
<blackface>Page Builder</blackface>
</p><p>
Time for the big one, now you can create your own web pages with WebTV. All items are functional, and your site will be published at community.webtv.zone. More page styles will be coming soon, but for now you have to pick from Blue Sands, Space, Cats, Republican, and American.
</p><p>
<blackface>Branding Update</blackface>
</p><p>
The branding demo test has concluded, as we're confident that it will work properly with all boxes. However, if you'd like to visit the page still, you can see it <a href="wtv-home:/brandingdemo">here</a>.
</p><p>
That's it for now, make sure to stick around because there's more coming.
</p><p>
