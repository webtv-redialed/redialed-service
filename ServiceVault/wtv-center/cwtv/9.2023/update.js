  ...
  <tr>
    <td><table width="408" cellspacing="0" cellpadding="0" border="0">
      ...
      <tr>
        <td abswidth="40"></td>
        <td valign="top">
<b><font size="+5" color="#C0F9A3">More Web Per TV</font><font size="5" color="#C0F9A3">
</font></b>
...
(What does "More Web Per TV" even mean?)
</p><p>
No new features this time around, however we've made many changes behind the scenes to improve your experience.
</p><p>
<blackface>Discuss this!</blackface>
</p><p>
We've fixed issues with the post listings in Discuss, so you can now properly flip through pages of posts.
</p><p>
<blackface><a href="wtv-music:/music/classicl/ragtime/joplin_entertainer.mid?wtv-title=The Entertainer">For the oldies</a></blackface>
</p><p>
There's also now a special, slightly less demanding home page for our users who for one reason or another, are stuck on older software versions.
</p><p>
<blackface>News 2: Electric Boogaloo</blackface>
</p><p>
We've switched around some of our news providers, and have decided to switch the Entertainment center's news provider from Deadline to The New York Times to match the rest of the centers.
</p><p>
